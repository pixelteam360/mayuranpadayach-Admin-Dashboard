...
import lock from "../../../assets/iamges/lock.png";
import ChangePasswordForm from "./ChangePasswordForm";

const ChangePassword = () => {
  return (
    <div className="flex justify-center items-center py-5">
      <div className=" max-w-[922px] bg-white/40 md:p-12 p-5 md:rounded-3xl rounded-2xl border-[3px] border-white text-center md:space-y-7 space-y-4">
